...
description: Reverse engineering binary analysis, identify file format, architecture, sections, imports, exports, strings, and packing before deeper work. Use when analyzing an ELF, PE, Mach-O, or firmware binary for the first time.
---
