...
| `delegation-guard.ts` — circuit breaker | **FAIL-CLOSE** | `throw` (dead-letter) após N spawns do mesmo alvo na janela | Quebra loop infinito de retry — o failure mode mais caro |
